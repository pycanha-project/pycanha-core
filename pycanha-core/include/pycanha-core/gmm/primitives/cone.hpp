...
class Cone {
  public:
    ...
    [[nodiscard]] double radius1() const noexcept;
    [[nodiscard]] double radius2() const noexcept;
    ...
    void set_radius1(double radius1) noexcept;
    void set_radius2(double radius2) noexcept;
