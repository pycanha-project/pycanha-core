...
TEST_CASE("radiative vf: a closed enclosure sees no space",
    ...
    const auto space_col = static_cast<std::int32_t>(scene.num_face_slots());
    for (std::int64_t row = 0; row < 12; row += 2) {
